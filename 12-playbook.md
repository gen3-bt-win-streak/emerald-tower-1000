...
> **⚠ 2026-09-05：カビゴン採用のC構成を検討中。壊れる条項と置き換えは本章末尾の[付章A](#付章a-c構成カビゴン採用への差分2026-09-05)にまとめてある。実機ではそちらを優先すること。**
>
> **凍結v4.2構築（2026-08-25確定・現行走行）**：先発 **サンダー@ラム**（10まん/めざ氷/でんじは/まもる）＋**メタグロス@フィラのみ**（コメパン/じしん/だいばくはつ/まもる・**EV H252/A244/B0/D8/S4＝実数値403/296/218**）／後発 **ラティオス@ひかりのこな**（**H40/C252/S216＝311/359/341**）＋**ラグラージ@たべのこし**（めざ岩70・**H248/A252/S8＝403/157**）。詳細は[15章](15-v4-real-build.md)編成表。

> **⚠ 2026-09-11 整理**：本章の §0〜§9 は v4（サンダー／ラグラージ）時代に書かれた本文で、**現行 v5 の差分は末尾の**付章B**に集約**されている。
...
> 4Pick監査（[24-pick4-audit.md](24-pick4-audit.md)）で **ラグラージ → カビゴン** の入れ替えが候補になり、
