...
- **退避先＝ラグラージ。ただし例外1つ**（2026-07-30に現行スペックで全16セット再計算）。ラグ（水/地面）は炎半減で、**16セット中15は最大43%**（#522ヘルガーのかみくだく。純粋な炎技なら最大41%＝#791ファイヤーOH）。グロスを引いてラグを出せば炎は無力化。
...
| 2 | #522 | ヘルガー | 43% | かみくだく | ✅ |
| 3 | #732 | ブースター | 42% | すてみタックル | ✅ |
| 4 | #791 | ファイヤー | 41% | オーバーヒート | ✅（炎技の最大） |
| 5〜16 | #875 #874 #769 #780 #656 #739 #752 #455 #454 #743 #742 #511 | 各種 | 30〜37% | オーバーヒート/だいもんじ | ✅ |

- **#714以外の15セットは最大43%＝退避は完全に安全**。#714のみソーラービーム（溜め1ターン）で確定OHKO。
...
|---|---:|---|---|---|---|---|
| #470 | 189(速) | 有 | **83%**(じしん 283-334) | **165%＝確1** | 109%(いわなだれ) | 危険(EQ+つるぎのまい) |
| #579 | 189(速) | 有 | **83%**(じしん) | **165%＝確1** | 109%(いわなだれ) | 危険(EQ+つるぎのまい) |
| #675 | 189(速) | 有 | **83%**(じしん) | **165%＝確1** | 109%(いわなだれ) | 危険(EQ+つるぎのまい) |
| #387 | 126(遅) | **無** | 42%(ボーンメラング) | — | 109%(いわなだれ) | 低速・EQ無 |

- **じしん有3セットは「無補正なら退避したラグは耐える（83%＝確定耐え）」が、つるぎのまい1回で165%＝確1**に変わる。
