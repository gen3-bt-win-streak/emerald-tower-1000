...
- **くろいきりは回避上昇（かげぶんしん55・ちいさくなる1）を見たときの専用解答。** 防御系（のろい/めいそう/てっぺき等56）と攻撃系（りゅうのまい/つるぎのまい等40）はカビゴンの殴り合いで解決するので、くろいきりを撃たない。
- くろいきりは自分のカビゴンののろいも消す。**カビゴンが積み終わっているならくろいきりは撃たない**（役割分担であって衝突ではない）。
