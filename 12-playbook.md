...
## 8.9 開幕脅威トリオ（ルージュラ/レジアイス/プテラ）の無命中依存ライン【2026-08-25】

> 走者報告「この3対面がコメパン85%依存できつい」→ 全セット×全100%技ラインを走査した結果、
> **3脅威中2つはコメパン不要**。真に命中依存が残るのはレジアイスのみで、それも まもる で圧縮できる。

### プテラ（4セット・S296-338）— コメパン封印してよい

**サンダー10まん 423-498＝全セット余裕の100%確1。** ラティは確1不可（最大312 vs HP343/乱1 25%）。
担当は必ずサンダー。※#531のみこだわりハチマキ（はかいこうせん/EQが1段重い）、他3つはおうじゃのしるし。

### ルージュラ（4セット・HP334・S226）— 100%コンボで確殺

**グロスEQ＋サンダー10まん（345-446）or グロスEQ＋ラグめざ岩** が全セットで334を超える。
コメパン（469-962確1）は過剰火力の85%賭けにすぎない。ルージュラは先手（S226>177）で
あくまのキッス等を撃ってくるが、ラム＋当ターン中の確殺で被害は1行動分で止まる。

### レジアイス（6セット）— 真のコメパン依存。ただし事故率は圧縮できる

構造：**特防456で特殊が通らず（10まん91-107）、物理はコメパンだけがSTAB×氷2倍（368-434）**。
EQは123-145で確2にすら遠く、**100%技の2枚コンボは最大274＜HP343-364＝存在しない**。

| 解 | 命中 | 備考 |
|---|---|---|
| コメパン | 85% | HP364の4セットに確1（#796/#838は確1なし） |
| **だいばくはつ 440-611** | **100%** | **全6セット確1**。ただし§4.1bのハピ条項と要調整 |

**推奨シーケンス（サンダー＋グロス開幕時）**：
1. **T1：グロス先手（S177＞122-136）コメパン＋サンダーまもる**
   → 85%で被弾ゼロ決着。外れても**まもるでれいB（サンダー乱1 312-368）を完全遮断**
2. 外れたT2：コメパン再抽選＋サンダーはラティへ交代（れいBはラティに137-162＝確3で安全受け）
3. **連続外れは2.25%**——「毎対面15%の即死露出」が「2.25%の遅延」まで落ちる
4. 控えにハピナスがいないと確認済みの盤面では、**爆発611が命中100の即答**（§4.1bの優先順位内で解禁）
...
|---|---|
| プテラ | **ゼロ**（10まん一択） |
| ルージュラ | **ゼロ**（EQ+集中の100%コンボ） |
| レジアイス | 85%→**まもる併用で実効97.75%**、爆発解禁盤面なら100% |
