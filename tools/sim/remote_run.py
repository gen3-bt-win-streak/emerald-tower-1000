...
if JOB == 'smoke':
    ...
    emit(dict(name='⑲改グロス:H200/A164/B46/D16/S84 fresh 3k-13k', **fresh_range(3000, 13000, 'ev19c')))
elif JOB == 'ev19d':
    G['our_team'] = make_bld({'Metagross': ('Leftovers', {'spe': 197, 'hp': 351, 'spd': 220})})
    ...
    G['our_team'] = make_bld({'Metagross': ('Metal Coat', {'hp': 351, 'atk': 376, 'spd': 225, 'spe': 197})})
    emit(dict(name='攻め収束改:MC/A144/S84/H200/B44/D36 fresh 3k-13k', **fresh_range(3000, 13000, 'ev20')))
elif JOB == 'ev20b':
    G['our_team'] = make_bld({'Metagross': ('Metal Coat', {'hp': 351, 'atk': 376, 'spd': 225, 'spe': 197})})
    emit(dict(name='攻め収束改:MC/A144/S84/H200/B44/D36 fresh 13k-23k', **fresh_range(13000, 23000, 'ev20b')))
elif JOB == 'qcswap':
    G['our_team'] = make_bld({'Metagross': 'Quick Claw', 'Swampert': 'Leftovers'})
    emit(dict(name='ツメ持ち主交換:グロス=ツメ/ラグ=残飯 fresh 3k-13k', **fresh_range(3000, 13000, 'qcswap')))
elif JOB == 'qcswapb':
    G['our_team'] = make_bld({'Metagross': 'Quick Claw', 'Swampert': 'Leftovers'})
    ...
    G['our_team'] = make_bld({'Metagross': ('Quick Claw', {'hp': 353, 'atk': 379, 'spd': 220, 'spe': 197}), 'Swampert': 'Leftovers'})
    emit(dict(name='⑲改改+ツメ:H208/A156/B46/D16/S84 fresh 3k-13k', **fresh_range(3000, 13000, 'v4s84a')))
elif JOB == 'v4s84b':
    G['our_team'] = make_bld({'Metagross': ('Quick Claw', {'hp': 353, 'atk': 379, 'spd': 220, 'spe': 197}), 'Swampert': 'Leftovers'})
    emit(dict(name='⑲改改+ツメ:H208/A156/B46/D16/S84 fresh 13k-23k', **fresh_range(13000, 23000, 'v4s84b')))
elif JOB == 'swampss':
    G['our_team'] = make_bld({'Metagross': 'Quick Claw', 'Swampert': 'Soft Sand'})
    emit(dict(name='最終戦:グロス=ツメ/ラグ=すな(EQ確1+11) fresh 3k-13k', **fresh_range(3000, 13000, 'swampss')))
elif JOB == 'swampssb':
    G['our_team'] = make_bld({'Metagross': 'Quick Claw', 'Swampert': 'Soft Sand'})
